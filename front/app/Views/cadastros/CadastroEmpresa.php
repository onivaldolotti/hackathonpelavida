    ...
    <div class="content-acompanhmento" align="center">
        <form class="form">
            <div class="form-row">
                ...
                <input type="text" class="form-control" id="nome_empresa" placeholder="Nome">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="responsavel" placeholder="Responsável pela Empresa">
                </div>
                <div class="form-group col-md-6">
